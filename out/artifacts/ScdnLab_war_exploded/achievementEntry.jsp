...
<div class="wrapper">
    ...
    <header class="main-header">
        ...
        <a class="logo">
            ...
            <span class="logo-lg"><b>SCDN</b>Admin</span>
        </a>
    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                <li class="active"><a href="#"><i class="fa fa-link"></i> <span>Role</span></a></li>
                ...
                <i class="fa fa-angle-left pull-right"></i>
                    ...
                    <ul class="treeview-menu">
                        <li><a href="achievementEntry.jsp">Achievements</a></li>
                        <li><a href="#">News</a></li>
                ...
                <div class="col-md-12">
                    <div class="bgc-white bd bdrs-3 p-20 mB-20"><h4 class="c-grey-900 mB-20">Simple Table</h4>
                        <p>Using the most basic table markup, here’s how <code class="highlighter-rouge">.table</code>-based
                            tables look in Bootstrap. <strong>All table styles are inherited in Bootstrap 4</strong>,
                            meaning any nested tables will be styled in the same manner as the parent.</p>
                        <table class="table">
                            <thead>
                            <tr>
                                <th scope="col">#</th>
    ...
    <footer class="main-footer">
        ...
        <!-- Default to the left -->
        <strong>Copyright &copy; 2018 <a href="#">SCDN Lab</a>.</strong> All rights reserved.
    </footer>
